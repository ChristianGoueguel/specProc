...
`peakfit` is based on the `minpack.lm::nlsLM` function that uses the Levenberg-Marquardt algorithm for searching the minimum value of the residuals sum square. The search process involves starting with an initial guess at the parameters values.
