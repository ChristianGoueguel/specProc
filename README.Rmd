...
peaks center `peaks.center` from your spectrum data and then fit them with the `peakfit` 
function. You can fit all peaks with same fitting function or fit each 
peak with a different profile function.
