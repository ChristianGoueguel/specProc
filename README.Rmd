...
version of the Gaussian function implemented in `gaussian_func` and given by the following expression:

<p align="center">
<img src="images/GaussianFun.png" width="340"/>
</p>

The Lorentzian function implemented in `lorentzian_func` has a much wider tails than the Gaussian function and is given by:
